...
public interface PengirimanRepository extends JpaRepository<Pengiriman, Long> {
    ...
    @Query(value = "update " + //
            ...
            "inner join pengiriman_checkpoint_pengiriman as c on c.pengiriman_id_pengiriman = b.id_pengiriman " + //
    ...
    @Modifying
    @Transactional
    @Query(value = "insert into pengiriman_checkpoint_pengiriman " +
            "(pengiriman_id_pengiriman, checkpoint_pengiriman_id_lokasi) " +
