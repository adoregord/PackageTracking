...
public class PengirimanService {
    ...
    public List<Pengiriman> addPengiriman(Pengiriman pengiriman) throws PengirimanException {
        ...
        // log.info("Pengiriman ID: " + pengiriman.getId_pengiriman() +
        // pengiriman.getIsReceived());

        // update isReceived mengecek dan mengubah nilai isReceived sesuai dengan tujuan
        // pengiriman paket
